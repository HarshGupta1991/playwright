...
test('Add an item to cart from Software Deprt', async ({page}) => {
    //open url
    ...
    await page.waitForTimeout(5000);
     ...
     //select software radio button
     await page.locator('//*[@id="DealsGridScrollAnchor"]/div[2]/div[1]/div/span[25]/div/label/span/span').click();
    // await page.pause();
     //click on first item
