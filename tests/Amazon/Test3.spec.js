...
test('Add an item to cart from Toys Deprt', async ({page}) => {
    //open url
    ...
    await page.waitForTimeout(5000);
     ...
     //select toys radio button
     await page.locator('//*[@id="DealsGridScrollAnchor"]/div[2]/div[1]/div/span[27]/div/label/span/span').click();
    // await page.pause();
     //click on first item
